...
class TestInterruptionTracking:
    ...
    def test_update_block_interruption_tracking(self):
        ...
        interrupted_usage = TokenUsage(input_tokens=100, was_interrupted=True, model="claude-3-opus-latest")
        ...
        non_interrupted_usage = TokenUsage(input_tokens=50, was_interrupted=False, model="claude-3-sonnet-latest")
        ...
        another_interrupted_usage = TokenUsage(input_tokens=75, was_interrupted=True, model="claude-3-sonnet-latest")
